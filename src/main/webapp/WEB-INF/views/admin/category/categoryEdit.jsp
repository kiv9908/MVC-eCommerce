                ...
                <form action="${pageContext.request.contextPath}/admin/category/edit" method="post" id="categoryForm" class="needs-validation" novalidate>
                        ...
                        <select class="form-select" id="parentId" name="parentId">
                            ...
                            <c:forEach var="parent" items="${parentCategories}">
                                <option value="${parent.id}"
                                        data-fullname="${parent.fullName}"
                                        data-level="${parent.level}"
                                    ${category.parentId == parent.id ? 'selected' : ''}>
                                        ${parent.fullName != null && !empty parent.fullName ? parent.fullName : parent.name}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light" id="fullName" name="fullName"
                               value="${category.fullName}" readonly>
                        <div class="form-text">카테고리명과 상위 카테고리 선택에 따라 자동으로 생성됩니다.</div>
                    </div>
...
<script src="${pageContext.request.contextPath}/js/admin/categoryEdit.js"></script>
